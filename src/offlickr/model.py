...
class Exif(BaseModel):
    # Level 1: always-visible capture summary
    ...
    # Level 3: raw field dump (noise-filtered, after PII removal at render time)
    raw_fields: dict[str, str] = Field(default_factory=dict)
    # PII fields: stored always, rendered only with --include-exif-pii
