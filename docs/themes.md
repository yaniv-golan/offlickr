...
| Albums index | Photo detail (with EXIF, geo, tags) |
| --- | --- |
| [![Albums](screenshots/albums.png)](screenshots/albums.png) | [![Photo detail](screenshots/photo-detail.png)](screenshots/photo-detail.png) |
