...
def test_account_location_parsed_from_city_country() -> None:
    data = {
        "nsid": "99@N00", "screen_name": "t", "join_date": "2010-01-01T00:00:00",
        "pro_user": "no", "profile_url": "https://flickr.com/people/t/",
        "city": "Tel Aviv", "country": "Israel", "hometown": "",
    }
...
def test_account_social_parsed() -> None:
    data = {
        ...
        "pro_user": "no", "profile_url": "https://flickr.com/people/t/",
        "social": {
            "instagram": "@testuser", "twitter": "", "facebook": "",
            "pintrest": "", "tumblr": "",
        },
    }
    account = Account.from_json(data)
