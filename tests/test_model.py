...
EXPECTED_PHOTO_COUNT = 5  # Album One now has 5 photos in the fixture
...
def test_album_parses() -> None:
    ...
    assert album.photo_ids == ["10000001", "10000002", "10000003", "10000011", "10000012"]
...
def test_person_ref_fields() -> None:
    p = PersonRef(
        nsid="77777777@N00",
        username="testfriend",
        profile_url="https://www.flickr.com/people/testfriend/",
    )
...
def test_album_back_ref_fields() -> None:
    a = AlbumBackRef(
        ...
        title="Album One",
        url_flickr="https://www.flickr.com/photos/testuser/sets/10000000000000001/",
    )
